...
namespace Rhino.Agent
{
    public class Startup
    {
        ...
        // statics
        private static readonly IEnumerable<Type> type = GetTypes();
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton(typeof(IEnumerable<Type>), type);
            services.AddSingleton(typeof(HttpClient), HttpClient);
            services.AddSingleton(typeof(Orbit), new Orbit(type));
